...
//    const handleVocabulary =async (word:string)=>{
//         const description = await handleClick(word);
            ...
            {type==='stock'&& <>
                ...
                <div className="stock-guide">
                    ...
                    <div className="stock-section">
                        ...
                        <div>
                            <div className="graph-btn" onClick={()=>handleClick('bar')}><img src={process.env.PUBLIC_URL + "bar-graph.png"} alt="kakao login" />막대 그래프</div>
                            <div className="graph-btn" onClick={()=>handleClick('candle')}><img src={process.env.PUBLIC_URL + "candle-graph.png"} alt="kakao login" />캔들 그래프</div>
                        </div>    
                        {/* </div> */}
                            {explain}
                            </div>
                    ...
                    <div className="trade-control">
                        <div className="company" onClick={()=>handleClick('company')}>삼성전자</div>    
                            <div className="stock-info">
                                <div className="market">
                                    <div className="market-price" onClick={()=>handleClick('stock Price')}>74,100</div>    
                            ...
                            {trade==='buy'&& <div className="trade-tab">
                                <div className="tradeBtn btn-selected" onClick={()=>{
                                    setTrade('buy');
                                    handleClick('buy');
                                    }}>매수</div>
                                <div className="tradeBtn" onClick={()=>{
                                    setTrade('sell');
                                    handleClick('sell');
                                    }}>매도</div>
                                <div className="tradeBtn" onClick={()=>{
                            ...
                            {trade==='sell'&& <div className="trade-tab">
                                <div className="tradeBtn" onClick={()=>{
                                    setTrade('buy');
                                    handleClick('buy');
                                    }}>매수</div>
                            ...
                            {trade==='modify'&& <div className="trade-tab">
                                <div className="tradeBtn" onClick={()=>{
                                    setTrade('buy');
                                    handleClick('buy');
                                    }}>매수</div>
