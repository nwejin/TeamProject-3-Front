    ...
    <>
      <div className="outer-wrapper">
        ...
        {type === 'stock' && (
          <>
            <ul>
              <li className="selected-blue" onClick={() => setType('stock')}>
                주식
              </li>
            ...
            <div className="stock-guide">
              ...
              <div className="trade-control">
                ...
                <div className="order">
                  ...
                  {trade === 'modify' && (
                    <TradeModify handleClick={handleClick} />
                  )}
                </div>
              </div>
            </div>
        ...
        {type === 'exchange' && (
          <>
            <ul>
              ...
              <li className="selected-blue" onClick={() => setType('exchange')}>
                환율
              </li>
              <li onClick={() => setType('invest')}>모의 투자</li>
            </ul>
        ...
        {type === 'invest' && (
          <>
            <ul>
              <li onClick={() => setType('stock')}>주식</li>
              <li onClick={() => setType('exchange')}>환율</li>
              <li className="selected-blue" onClick={() => setType('invest')}>
                모의 투자
              </li>
            </ul>
            <Virtual />
